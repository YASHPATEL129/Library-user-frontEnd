...
(function ($) {
    ...
    $('#search-btn').on("click", function () {
       ...
       if(window.location.pathname == "/home"){
        window.location.href = '/books?q='+ q;     
       }
       searchBooks(q);
      });
    ...
    function searchBooks(query) {
        ...
        var url = (selectedCat== undefined || selectedCat == null || selectedCat=='') ? '/search?query=' + query : '/search?query=' + query + "&categoryIds=" + selectedCat;
        console.log(url);
          $.ajax({
              type: 'GET',
